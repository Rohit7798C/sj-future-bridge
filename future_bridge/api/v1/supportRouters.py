...
class SupportRepository:
    ...
    async def add_comment_to_ticket(self, user_email: EmailStr, ticket_id: str, comment: str, attachments: Optional[List[str]] = None):
        ...
        try:
            ...
            # if use_object_id:
            #     filter_query = {"_id": object_id, "username": user_email}
            # else:
            #     filter_query = {"ticket_id": ticket_id, "username": user_email}
            ...
            # ✅ Ensure correct ticket update by user
            ...
            # if use_object_id:
            #     updated_ticket = await support_collection.find_one({"_id": object_id})
            # else:
            #     updated_ticket = await support_collection.find_one({"ticket_id": ticket_id})
